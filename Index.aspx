 ...
 <div data-ng-app="myApp" data-ng-controller="MenuController">
        ...
        <ul data-ng-style="subLeft">
            ...
            <li class="sub" data-ng-repeat="sublink in sublinks">   
                ...
                <a class="btn" data-ng-href="{{sublink.href}}" target="{{sublink.target}}" >{{sublink.title}}</a>
            </li>
        </ul>
	...
	<section id="main"><!-- #main content and sidebar area -->
			<section id="content"><!-- #content -->
        		...
        		<article>
							...
							<p><img src="" alt="" class="alignleft" />First Article Title.</p>
						</article>
						
        		<article>
							<h2><a href="#">Second Article Title</a></h2>Second Article Title.
							<p><img src="" alt="" class="alignright" /></p>
						</article>
